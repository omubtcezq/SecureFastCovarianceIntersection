...
To achieve a secure solution to the FCI fusion problem, we make use of two types of function-providing encryption schemes. The Paillier additive PHE scheme \cite{paillierPublicKeyCryptosystemsBased1999} which provides a single homomorphic addition operation, and the Lewi ORE scheme \cite{lewiOrderRevealingEncryptionNew2016} which provides a secure comparison function.
