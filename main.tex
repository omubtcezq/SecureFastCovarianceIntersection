...
% The following cause issues with equation numbering (disabled for time being)
%\usepackage{BNPackages/BNPackages}
%\usepackage{BNPackages/BNMathMacros}% typical math macros
% the following might not be useful in this context
%\usepackage{BNPackages/BNMathEstimation}% math macros for estimation
