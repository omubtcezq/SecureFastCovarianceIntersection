...
Finally, values of $\omega_{i,SecFCI}$, $\omega_{i,FCI}$ and $|\vec{\omega}_{FCI} - \vec{\omega}_{SecFCI}|$ have been plotted over time in Fig. \ref{fig:fci_secfci_omegas}, and show the commputed error bound when $n=3$ and $s=0.1$.
\begin{figure}[tb]
   %\vspace{-5pt}
   \begin{center}
