...
%DIF ADD main.tex               Wed May  6 12:27:32 2020
...
\subsection{\DIFadd{Computational Complexity}}
\DIFadd{Given sensor state estimates, estimate errors, and error traces at each sensor, we wish to show the computational complexity of the SecFCI algorithm for the $n$ sensor case. We will make the assumption that both the Lewi ORE and Paillier PHE schemes use the same length security parameter (and equivalently key size), such that
}\begin{equation}
