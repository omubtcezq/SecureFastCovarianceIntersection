...
%DIF ADD main.tex               Tue May 12 17:07:01 2020
...
\DIFaddbegin \bstctlcite{IEEEexample:BSTcontrol}
\DIFaddend 
...
\cite{aristovEncryptedMultisensorInformation2018}}\hspace{0pt}%DIFAUXCMD
, and the possibility of choosing sufficiently large integer and fractional bit lengths $i$ and $f$, we will only consider the error caused by the difference in weights. We will treat this error as the distance between respective weight vectors
}\begin{equation}
