...
%DIF ADD main.tex               Thu Jun  4 10:37:19 2020
...
To achieve a secure solution to the FCI fusion problem, we make use of two types of function-providing encryption schemes. The Paillier additive PHE scheme \cite{paillierPublicKeyCryptosystemsBased1999} \DIFdelbegin \DIFdel{providing }\DIFdelend \DIFaddbegin \DIFadd{which provides }\DIFaddend a single homomorphic addition operation, and the Lewi ORE scheme \cite{lewiOrderRevealingEncryptionNew2016} \DIFdelbegin \DIFdel{providing }\DIFdelend \DIFaddbegin \DIFadd{which provides }\DIFaddend a secure comparison function.
